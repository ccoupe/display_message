...
class Settings:
  ...
  def load_settings(self, fn):
    ...
    self.notecmd_sub = conf.get('notecmd_sub', 'homie/' + self.homie_device + '/display/cmd/set')
    self.notetext_sub = conf.get('notetext_sub', 'homie/' + self.homie_device + '/display/text/set')
